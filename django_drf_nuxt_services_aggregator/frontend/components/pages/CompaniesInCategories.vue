  ...
  <div>
    <div class="container">
      ...
      <div class="my-4 title-list-companies">
        <span class="sub-text">
          Найдено {{ companies.count }} сервисных центра по ремонту техники
          <span v-if="name_slug">{{ name_slug }}</span> в городе
          {{ $store.getters["cities/activeCity"].name }}
        </span>
      </div>
    ...
    <div class="container mt-3">
      <div class="row">
        ...
        <div class="yandex-car col-12 mb-4" v-if="markerPoint.length">
...
export default {
  ...
  data() {
    return {
      title: `Ремонт ${this.name_slug} в ${this.$store.getters["cities/activeCity"].declension_p}`,
      category_name: "",
      companies_list: [],
...
@media all and(max-width: 767px) {
  ...
  .companies-page-content .company-option {
    margin-right: 0px;
    text-shadow: none;
    font-size: 0;
